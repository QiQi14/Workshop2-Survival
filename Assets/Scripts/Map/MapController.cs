...
public class MapController : MonoBehaviour
{
    ...
    public float maxOpdist; //Must greater than length and width of the tilemap
    float opDist;
    ...
    void ChunkChecker()
    {
        ...
        if (pm.moveDir.x > 0 && pm.moveDir.y == 0) //right position
        {
        ...
        else if (pm.moveDir.x < 0 && pm.moveDir.y == 0) //left position
        {
        ...
        else if (pm.moveDir.x == 0 && pm.moveDir.y > 0) //top position
        {
        ...
        else if (pm.moveDir.x == 0 && pm.moveDir.y < 0) //down position
        {
